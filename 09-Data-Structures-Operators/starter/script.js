...
const arr = [1, 2, ...[3, 4]];
console.log(arr); // Takes 3 and 4 and includes them directly in the arr array

//	Rest because it's on the left side of =
const [a, b, ...others] = [1, 2, 3, 4, 5];
console.log(a, b, others); // Takes the remaining elements and puts them in the others variable as an array
...
const newMenu = [...restaurant.mainMenu, `Gnocci`]; // Example of where it might be useful
console.log(newMenu);
...
({ a, b } = obj); // We need to wrap the mutation because if we start with { Javascript expects a code block which can't be = something
...
/* let [main, , secondary] = restaurant.categories; // leaving a hole between , will skip an element
